            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="mb-9 text-base leading-relaxed dark:text-dark-6">
                  The team at Sai Service Centre is readily available to assist
                  you with all your electronic repair needs. Just as we are
                  committed to providing reliable and customer-focused service,
                  we aim to make contacting us a seamless experience. Whether
                  you have inquiries about our repair services, want to schedule
                  a device repair, or simply need guidance, don't hesitate to
                  reach out through the contact details provided below. We value
                  your trust and look forward to ensuring your electronic
                  devices are in capable hands.
                </p>
